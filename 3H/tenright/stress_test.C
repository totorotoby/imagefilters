...
int main(int argc, char *argv[])
{
	...
	rt1.SetInput(mr.GetOutput());
	rt2.SetInput(rt1.GetOutput());
	tb1.SetInput(rt2.GetOutput());
    tb1.SetInput2(reader.GetOutput());
	
    //should make an image of deschutes with a greater than symbol in the sky
