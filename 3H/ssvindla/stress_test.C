...
int main(int argc, char *argv[])
{
    ...
    /*   Will roate the image 360 degrees. (i.e. input and output should be the same)   */
    Rotate r0;
    Rotate r1;
    Rotate r2;
    Rotate r3;

    r0.SetInput(reader.GetOutput());
    r1.SetInput(r0.GetOutput());
