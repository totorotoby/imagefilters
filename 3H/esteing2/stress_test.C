...
int main(int argc, char *argv[])
{
    ...
    PNMreader reader1("../images/gnu.pnm");  // note: filename must be "../images/image_name.pnm"
    ...
    lr1.SetInput(reader1.GetOutput());
    lr1.SetInput2(reader2.GetOutput());

    lr2.SetInput(lr1.GetOutput());
    lr2.SetInput2(reader3.GetOutput());

    mr1.SetInput(reader3.GetOutput());
